...
class vehiculo{
	...
	public function get_list(){
		...
		<div class="container">
			...
			<tr>
				<th colspan="8"><a class="btn btn-primary" href="vehiculo.php?d=' . $d_new_final . '">Nuevo</a></th>
			</tr>
			<tr>
				<th>Placa</th>
				<th>Marca</th>
			...
			*/
				...
				$html .= '
					<tr>
						...
						<td>' . $row['anio'] . '</td>
						<td>' . $row['avaluo'] . '</td>
						<td><a class="btn btn-danger" href="vehiculo.php?d=' . $d_del_final . '">Borrar</a></td>
						<td><a class="btn btn-warning" href="vehiculo.php?d=' . $d_act_final . '">Actualizar</a></td>
						<td><a class="btn btn-success" href="vehiculo.php?d=' . $d_det_final . '">Detalle</a></td>
					</tr>';
...
public function get_detail_vehiculo($id){
	...
	*/
		...
		<table border="0" align="center" class="table table-striped">
			...
			<tr>
				<th colspan="2"><a class="btn btn-primary" href="vehiculo.php">Regresar</a></th>
			</tr>																						
		</table></div></div>';
...
//***************************************************************************************************************************
	...
	private function _message_error($tipo){
		...
		<table border="0" align="center" class="table table-striped">
			...
			<tr>
				<th><a class="btn btn-primary" href="vehiculo.php">Regresar</a></th>
			</tr>
		</table>';
		return $html;
	}
